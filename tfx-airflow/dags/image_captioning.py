...
_pipeline_name = 'image_captioning'

# This example assumes that the taxi data is stored in ~/taxi/data and the
# taxi utility function is in ~/taxi.  Feel free to customize this as needed.
_taxi_root = os.path.join(os.environ['HOME'], 'airflow')
_data_root = os.path.join(_taxi_root, 'data', 'tfrecord')
# Python module file to inject customized logic into the TFX components. The
# Transform and Trainer both require user-defined functions to run successfully.
_module_file = os.path.join(_taxi_root, 'dags', 'image_train.py')
...
def _create_pipeline(pipeline_name: Text, pipeline_root: Text, data_root: Text,
  ...
  example_gen = component.ImportExampleGen(input_base=_data_root)
